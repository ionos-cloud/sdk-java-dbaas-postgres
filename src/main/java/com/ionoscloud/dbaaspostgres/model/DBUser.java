...
public class DBUser {
   ...
   * @return username
  **/
  @ApiModelProperty(example = "db-admin", required = true, value = "The username for the initial PostgreSQL user. Some system usernames are restricted (e.g. \"postgres\", \"admin\", \"standby\"). ")
