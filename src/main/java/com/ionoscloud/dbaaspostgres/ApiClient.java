...
import com.ionoscloud.dbaaspostgres.auth.Authentication;
import com.ionoscloud.dbaaspostgres.auth.HttpBasicAuth;
import com.ionoscloud.dbaaspostgres.auth.HttpBearerAuth;
import com.ionoscloud.dbaaspostgres.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://api.ionos.com/databases/postgresql";
    ...
    private void init() {
        ...
        setUserAgent("ionos-cloud-sdk-java-dbaas-postgres/v1.2.0");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.ionos.com/databases/postgresql
